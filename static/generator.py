...
class Generator(object):
    def __init__(self, opts):
        ...
        self.runtime_classes_path = opts['runtime_classes_path']
...
def main():
    ...
    ini_file = opts.ini_cfg or 'userconf.ini'
    if not os.path.isfile(ini_file):
        raise Exception("invalid ini file: " + ini_file)
    userconfig.read(ini_file)
    ...
    moduleIniFile = args[0]
    config = ConfigParser.SafeConfigParser()
    config.read(moduleIniFile)
    ...
    for t in targets:
        ...
        for s in sections:
            ...
            gen_opts = {
                ...
                'runtime_classes_path':os.path.abspath(os.path.join(userconfig.get('DEFAULT', 'frameworks'), 'runtime-src', 'Classes')),
